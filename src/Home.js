    ...
    if (hasAnimated) {
      ...
      gsap.to('.fyve-image-container', {
        ...
        onComplete: () => {
          ...
          console.log('After animation viewport innerWidth:', window.innerWidth, 'document.clientWidth:', document.documentElement.clientWidth);
          if (homePage) console.log('Final home-page rect', homePage.getBoundingClientRect());
          if (mask) console.log('Final mask rect', mask.getBoundingClientRect());
          if (container) console.log('Final container rect', container.getBoundingClientRect());
        }
      });
