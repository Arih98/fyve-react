  ...
  useEffect(() => {
    ...
    if (hasAnimated) {
      ...
      gsap.fromTo(
        '.fyve-letter',
        { y: '100%' },
        { y: 0, duration: 1.04, ease: 'expo.inOut' }
      );
      gsap.to('.fyve-text:first-child', { x: '-0.3vw', duration: 1.04, ease: 'expo.inOut', delay: 1.56 });
      gsap.to('.fyve-text:last-child', { x: '0.3vw', duration: 1.04, ease: 'expo.inOut', delay: 1.56 });
      gsap.to('.fyve-image-container', { width: '18vw', duration: 1.04, ease: 'expo.inOut', delay: 1.3 });
      gsap.to('.mask-left', { x: '-100%', duration: 1.04, ease: 'expo.inOut', delay: 1.3 });
      gsap.to('.mask-right', { x: '100%', duration: 1.04, ease: 'expo.inOut', delay: 1.3 });
      gsap.to('.fyve-text:first-child', { x: '-100vw', duration: 1.04, ease: 'expo.inOut', delay: 2.6 });
      ...
      gsap.fromTo(
        '.london-letter',
        { y: '100%' },
        { y: 0, duration: 1.04, ease: 'expo.inOut', delay: 0.5 }
      );
      gsap.to('.london-mask .london-text:first-child', { x: '-8.9vw', duration: 1.04, ease: 'expo.inOut', delay: 1.8 });
      gsap.to('.london-mask .london-text:last-child', { x: '8.9vw', duration: 1.04, ease: 'expo.inOut', delay: 1.8 });
      gsap.to('.london-mask .london-text:first-child', { x: '-100vw', duration: 1.04, ease: 'expo.inOut', delay: 3.1 });
      gsap.to('.london-mask .london-text:last-child', { x: '100vw', duration: 1.04, ease: 'expo.inOut', delay: 3.1 });
      gsap.to('.london-mask', { marginTop: `-${londonHeight}vw`, y: `${londonY + londonHeight}vw`, duration: 1.04, ease: 'expo.inOut', delay: 3.1 });
    }
    hasAnimated = true;
  }, []);
