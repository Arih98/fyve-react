  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      if (shouldSkipIntro) {
        ...
        gsap.set('.fyve-image-cover-left', { x: '-100%' });
        gsap.set('.fyve-image-cover-right', { x: '100%' });
      ...
      gsap.set('.fyve-image-cover-left', { x: '0%' });
      gsap.set('.fyve-image-cover-right', { x: '0%' });
      gsap.set('.fyve-text', { y: `${fyveTextY}vw` });
      gsap.set('.london-mask', {
        xPercent: -50,
        yPercent: -50,
      ...
      tl.addLabel('lettersIn')
        ...
        .to('.fyve-image-cover-left', {
          x: '-100%',
          duration: 0.8 * speed,
          ease: 'power2.out'
        }, 'splitOpen+=0.2')
        .to('.fyve-image-cover-right', {
          x: '100%',
          duration: 0.8 * speed,
          ease: 'power2.out'
        }, 'splitOpen+=0.2')
            ...
            <div className="fyve-brand-layer">
              <div className="fyve-mask">
                ...
                <div className="fyve-image-container">
                  ...
                  <div className="fyve-image-cover fyve-image-cover-left"></div>
                  <div className="fyve-image-cover fyve-image-cover-right"></div>
                </div>
