...
gsap.to('.home-mobile-top-logo', {
  ...
  delay: 2.8
        ...
        gsap.to('.london-mask .london-text:first-child', { x: '-150vw', duration: 0.8, ease: 'power2.inOut', delay: 2 })
gsap.to('.london-mask .london-text:last-child', { x: '150vw', duration: 0.8, ease: 'power2.inOut', delay: 2 })
