...
gsap.set('.london-below', { opacity: 0 });
        gsap.fromTo('.fyve-letter', { y: '100%' }, { y: 0, duration: 1.3 * speed, ease: 'expo.inOut' });
        gsap.to('.fyve-text:first-child', { x: fyveMoveX, duration: 0.8 * speed, ease: 'expo.inOut', delay: 1 * speed });
...
gsap.to('.london-mask .london-text:last-child', { x: londonMoveXEnd, duration: 0.8 * speed, ease: 'expo.inOut', delay: 1.2 * speed });
        gsap.to('.london-mask .london-text:first-child', { x: '-140vw', duration: 0.95 * speed, ease: 'power2.inOut', delay: 2 * speed, onComplete: () => gsap.set('.london-mask .london-text:first-child', { visibility: 'hidden' }) });
gsap.to('.london-mask .london-text:last-child', { x: '140vw', duration: 0.95 * speed, ease: 'power2.inOut', delay: 2 * speed, onComplete: () => gsap.set('.london-mask .london-text:last-child', { visibility: 'hidden' }) });
