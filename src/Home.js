...
const Home = () => {
  useEffect(() => {
    ...
    if (hasAnimated) {
      ...
      gsap.to('.london-mask .london-text:first-child', { x: '-8.8vw', duration: 0.8, ease: 'expo.inOut', delay: 1 });
      gsap.to('.london-mask .london-text:last-child', { x: '8.8vw', duration: 0.8, ease: 'expo.inOut', delay: 1 });
