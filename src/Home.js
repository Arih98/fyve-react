...
const Home = () => {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      const fyveMoveX = isMobile ? '-100px' : '-0.4vw';
      const fyveMoveXEnd = isMobile ? '100px' : '0.4vw';
      ...
      if (hasAnimated.current) {
        ...
        // FYVE text animations using a timeline
        const fyveTl = gsap.timeline();
        gsap.fromTo(
          '.fyve-letter',
          { y: '100%' },
          { y: 0, duration: 1.3, ease: 'expo.inOut' }
        );
        console.log('Animating fyve-text to:', fyveMoveX, fyveMoveXEnd);
        fyveTl.to('.fyve-text:first-child', { x: fyveMoveX, duration: 1.2, ease: 'expo.inOut', delay: 1 });
        fyveTl.to('.fyve-text:last-child', { x: fyveMoveXEnd, duration: 1.2, ease: 'expo.inOut', delay: 1 }, '<'); // Run simultaneously
        fyveTl.to('.fyve-text:first-child', { x: '-100vw', duration: 0.8, ease: 'expo.inOut', onComplete: () => gsap.set('.fyve-text:first-child', { visibility: 'hidden' }) });
        fyveTl.to('.fyve-text:last-child', { x: '100vw', duration: 0.8, ease: 'expo.inOut', onComplete: () => gsap.set('.fyve-text:last-child', { visibility: 'hidden' }) }, '<');
        ...
        gsap.to('.fyve-image-container', { width: '100vw', height: '100vh', duration: 0.8, ease: 'expo.inOut', delay: 2.2 });
        ...
        console.log('Animating london-text to:', londonMoveX, londonMoveXEnd);
        gsap.to('.london-mask .london-text:first-child', { x: londonMoveX, duration: 1.2, ease: 'expo.inOut', delay: 1 });
        gsap.to('.london-mask .london-text:last-child', { x: londonMoveXEnd, duration: 1.2, ease: 'expo.inOut', delay: 1 });
        gsap.to('.london-mask .london-text:first-child', { x: '-100vw', duration: 0.8, ease: 'expo.inOut', delay: 2.2, onComplete: () => gsap.set('.london-mask .london-text:first-child', { visibility: 'hidden' }) });
        gsap.to('.london-mask .london-text:last-child', { x: '100vw', duration: 0.8, ease: 'expo.inOut', delay: 2.2, onComplete: () => gsap.set('.london-mask .london-text:last-child', { visibility: 'hidden' }) });
        gsap.to('.london-mask', { marginTop: `-${londonHeight}vw`, y: `${londonY + londonHeight}vw`, duration: 0.8, ease: 'expo.inOut', delay: 2.2 });
