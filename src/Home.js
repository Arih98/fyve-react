...
const Home = () => {
  useEffect(() => {
    ...
    if (hasAnimated) {
      ...
      gsap.to('.london-mask .london-text:first-child', { x: '-8.9vw', duration: 1.04, ease: 'expo.inOut', delay: 1.3 });
      gsap.to('.london-mask .london-text:last-child', { x: '8.9vw', duration: 1.04, ease: 'expo.inOut', delay: 1.3 });
      gsap.to('.london-mask .london-text:first-child', { x: '-100vw', duration: 1.04, ease: 'expo.inOut', delay: 2.6 });
      gsap.to('.london-mask .london-text:last-child', { x: '100vw', duration: 1.04, ease: 'expo.inOut', delay: 2.6 });
      gsap.to('.london-mask', { marginTop: `-${londonHeight}vw`, y: `${londonY + londonHeight}vw`, duration: 1.04, ease: 'expo.inOut', delay: 2.6 });
    }
    hasAnimated = true;
  }, []);
