...
gsap.to('.home-mobile-top-logo', {
  ...
  delay: 2.8
        ...
        gsap.to('.london-mask .london-text:first-child', { x: '-150vw', duration: 1, ease: 'power2.inOut', delay: 2, onComplete: () => gsap.set('.london-mask .london-text:first-child', { visibility: 'hidden' }) });
        gsap.to('.london-mask .london-text:last-child', { x: '150vw', duration: 1, ease: 'power2.inOut', delay: 2, onComplete: () => gsap.set('.london-mask .london-text:last-child', { visibility: 'hidden' }) });
