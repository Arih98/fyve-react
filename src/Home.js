...
const Home = () => {
  useEffect(() => {
    ...
    if (hasAnimated) {
      ...
      gsap.set('.london-text:first-child', { x: '-100vw' });
      gsap.set('.london-text:last-child', { x: '100vw' });
      ...
      gsap.fromTo('.london-letter', { y: '100%' }, { y: 0, duration: 0.8, ease: 'expo.inOut' });
      ...
      gsap.to('.london-text:first-child', { x: '-0.3vw', duration: 0.8, ease: 'expo.inOut', delay: 1.2 });
      gsap.to('.london-text:last-child', { x: '0.3vw', duration: 0.8, ease: 'expo.inOut', delay: 1.2 });
      ...
      gsap.to('.london-text:first-child', { x: '-100vw', duration: 0.8, ease: 'expo.inOut', delay: 2 });
      gsap.to('.london-text:last-child', { x: '100vw', duration: 0.8, ease: 'expo.inOut', delay: 2 });
    ...
    <div className="home-page">
      ...
      <div className="fyve-mask">
        <div className="fyve-text">
          {'FY'.split('').map((letter, i) => (
            <span key={i} className="fyve-letter">{letter}</span>
          ))}
        </div>
        ...
        <div className="fyve-text">
          {'VE'.split('').map((letter, i) => (
            <span key={i+2} className="fyve-letter">{letter}</span>
          ))}
        </div>
      </div>
      <div className="london-mask">
        <div className="london-text">
          {'LON'.split('').map((letter, i) => (
            <span key={i} className="london-letter">{letter}</span>
          ))}
        </div>
        <div className="london-text">
          {'DON'.split('').map((letter, i) => (
            <span key={i+3} className="london-letter">{letter}</span>
          ))}
        </div>
      </div>
    </div>
